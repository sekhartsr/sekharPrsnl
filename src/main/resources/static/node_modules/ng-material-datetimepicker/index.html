...
<head>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/angular.js/1.6.7/angular-sanitize.js"></script>
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.19.3/moment-with-locales.min.js"></script>
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/angular-i18n/1.6.7/angular-locale_fr.min.js"></script>
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/angular-i18n/1.6.7/angular-locale_en.min.js"></script>
    ...
    <div layout-gt-md="row" layout="column" layout-align-gt-md="center center">
      ...
      <div layout-gt-md="row" layout="column" layout-align-gt-md="center center">
        <md-input-container flex-gt-md="30">
          ...
          <input mdc-datetime-picker date="true" time="true" minutes="true" type="text" id="datetimetmpl"
